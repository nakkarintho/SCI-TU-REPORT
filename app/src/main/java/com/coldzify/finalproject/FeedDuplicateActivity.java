...
public class FeedDuplicateActivity extends AppCompatActivity {
    ...
    private String ansProblemType;
    private String ansRoom;

    SwipeRefreshLayout swipeRefreshLayout;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feed_duplicate);

        ansProblemType = getIntent().getStringExtra("problemType");
        ansRoom = getIntent().getStringExtra("room");
        Log.d("FOUND ITEM 2", ansProblemType + "  , " + ansRoom);
        init();
        getReports();
        getTokenId();
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful() && task.getResult() != null) {
                            ...
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                if(report.getType().equals(ansProblemType) && report.getRoom().equals(ansRoom)) {
                                    reports.add(report);
